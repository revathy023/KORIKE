...
/*  $sql4="SELECT comp_id,category,subcategory,location,description,status
FROM complaintregistration INNER JOIN completed			 ON complaintregistration.l_id = completed.l_id WHERE l_id='".$_SESSION['hello']."'";  */




			/* $sql4="select * from complaintregistration where l_id='".$_SESSION['hello']."'" ;   
		    $result3 =mysqli_query($db,$sql4); */
			
			$sql4="SELECT comp_id,category,subcategory,  					
location,description,status
FROM complaintregistration where l_id=	'".$_SESSION['hello']."'	
UNION    					
SELECT   comp_id,category,subcategory,  												
location,description,status     
FROM  completed	where l_id='".$_SESSION['hello']."'";	
		$result3 =mysqli_query($db,$sql4);											
...
echo $x['subcategory'];}?>
													...
													<td ><?php echo $p['description']?></td>
														<td><a href="reraise.php?c=<?php echo$p['comp_id']?> "><?php echo $p['status'];?></a></td>
