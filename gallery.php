					...
					<div class="page-content">
							...
							<div class="col-xs-12">
								<div class="widget-box">
									...
									<h5 class="lighter block green">Enter The Caption</h5>
															<label class="block clearfix">
														<span class="block input-icon ">
															<input type="text"name="caption" class="input-medium" placeholder="caption" />
																	...
																	<div >
														<input type="file"             name="my"  /></div>
									
									
									
									<button type="submit" name="reg" class="btn btn-app btn-purple btn-sm">
										...
										<table id="simple-table" class="table  table-bordered table-hover">
											...
											<?php
															...
															$sql4="select image,caption from images where l_id='".$_SESSION['hello']."'" ;
...
if(isset($_POST['reg'])){
	...
	$imh=$_FILES["my"]["name"];
	                   ...
	                   move_uploaded_file($_FILES["my"]["tmp_name"],"project/assets/images/gallery/".$_FILES["my"]["name"]);
	//$imh="/assets/images/gallery/".$imh;
	
	
	
	$sql1="INSERT INTO images( l_id,image,caption) VALUES ('".$_SESSION['hello']."','".$imh."','".$cap."')";
